...
INSERT INTO `authors` VALUES (1,'Adam','Mickiewicz'),(2,'Juliusz','Słowacki'),(3,'William','Shakespeare'),(4,'Jan','Kochanowski'),(5,'Aleksander','Fredro'),(6,'Henryk','Sienkiewicz'),(7,'Bolesław','Prus'),(8,'Stanisław','Wyspiański'),(9,'Lew','Tołstoj'),(10,'J.R.R.','Tolkien'),(11,'J.K.','Rowling'),(12,'Unni','Lindell'),(20,'a','b');
...
INSERT INTO `book_author` VALUES (1,1),(1,2),(1,3),(2,4),(2,5),(2,6),(3,7),(3,8),(3,9),(4,10),(5,11),(6,12),(6,13),(6,14),(6,15),(7,16),(8,17),(9,18),(9,19),(10,20),(10,21),(11,22),(11,23),(11,24),(11,25),(11,26),(11,27),(11,28),(11,29),(12,30),(12,31),(12,32),(1,33),(20,68);
...
CREATE TABLE `opinions` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `opinions_ibfk_1` FOREIGN KEY (`id_book`) REFERENCES `books` (`id_book`),
...
INSERT INTO `opinions` VALUES (8,3,'Świetna historia o tragicznej miłości!',0),(25,3,'a',0),(25,4,'b',0),(25,5,'Trzecia częćś przygód młodego czarodzieja zachwyca.',0),(25,6,'c',0),(25,14,'aaaa',0),(30,1,'Wciąga fabułą!!',0);
...
-- Dump completed on 2019-06-04 19:07:03
